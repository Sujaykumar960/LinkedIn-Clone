  ...
  const fetchData = async() => {
    try{
      const [userData, postData] = await Promise.all([
        await api.get('/api/users/self'),
        await api.get('/api/post/getAllPost')
      ]);
        ...
        <div>
          <Card padding={1}>
            ...
            <div className='w-full flex mt-3'>
              ...
              <div onClick={()=>setAddPostModal(true)} className='flex gap-2 p-2 cursor-pointer justify-center rounded-lg w-[33%] hover:bg-gray-100'><ImageIcon sx={{color: 'blue'}} />Photo</div>
