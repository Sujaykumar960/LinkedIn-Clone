    ...
    <Card padding={0}>
        <div className='flex gap-3 p-4'>
            <div className='w-12 h-12 rounded-4xl'>
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNfTkosk_XISYGUe8YAUWMrv0kcP5a4YMcVQ&s" alt="" className='rounded-4xl w-12 h-12 border-2 border-white cursor-pointer' />
            </div>
            <div>
        ...
        <div className='my-2 p-4 flex justify-between items-center'>
            <div className='flex gap-1 items-center'>
                <ThumbUpIcon sx={{color: "blue", fontSize: 20}}/> <div className='text-sm text-gray-600'>1 Like</div>
            </div>
            <div className='flex gap-1 items-center'>
        ...
        <div className='flex p-1'>
            ...
            <div className='w-[33%] justify-center flex gap-2 items-center border-r-1 border-gray-100 p-2 cursor-pointer hover:bg-gray-100'><CommentIcon sx={{fontSize:22}} /> <span>Comment</span> </div>
            <div className='w-[33%] justify-center flex gap-2 items-center border-r-1 border-gray-100 p-2 cursor-pointer hover:bg-gray-100'><SendIcon sx={{fontSize:22}} /> <span>Share</span> </div>
        </div>
