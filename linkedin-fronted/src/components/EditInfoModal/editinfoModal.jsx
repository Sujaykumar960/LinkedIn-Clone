  ...
  return (
    <div className='mt-8 w-full h-[350px] overflow-auto'>
        ...
        <div className='w-full mb-4'>
            ...
            <br />
            <textarea value={data.headline} onChange={(e)=>{onChangeHandle(e,'headline')}} name="" id="" className='p-2 mt-1 w-full border-1 rounded-md' cols={10} rows={3}></textarea>
        </div>

        <div className='w-full mb-4'>
            <label>Current Company*</label>
            <br />
            <input value={data.curr_company} onChange={(e)=>{onChangeHandle(e,'curr_company')}} type="text" className='p-2 mt-1 w-full border-1 rounded-md' placeholder='Current Company Name'/>
        </div>
